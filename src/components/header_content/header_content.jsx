...
function Header_content() {
  return (
    <div  id="header_content" className='flex text-white pt-[170px] flex-col items-center 1331_px:pt-[200px]'>
      ...
      <img id="img_header" className='h-[540px] w-[840px] relative bottom-10 1331_px:h-[470px]' src="src/assets/bike.png"></img>
    </div>
  )
}
